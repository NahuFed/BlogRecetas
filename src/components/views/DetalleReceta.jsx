...
const DetalleReceta = () => {
    return (
        <div className='p-5 border border-3 sketchy'>
            ...
            <Image src='https://www.elmundoeats.com/wp-content/uploads/2019/09/Pasta-Frola-2.jpg' className='img-detalle' alt='Pasta Frola'></Image>
            ...
            <h3>Paso A Paso para hacer Pasta Frola</h3>
            <ol >
